...
const STAT_CONFIGS = [
  ...
  },
  {
    ...
    bg: 'bg-blue-50',
    iconBg: 'bg-gradient-to-br from-blue-500 to-brand-500',
  },
  {
    key: 'visibility',
...
export default function CandidateDashboard() {
  ...
  const { data: analyses } = useQuery<GapAnalysis[]>({
          ...
          <div className="card group relative overflow-hidden py-5">
            ...
            <div className="relative flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-2xl font-extrabold text-gray-900">{analyses?.length ?? 0}</p>
